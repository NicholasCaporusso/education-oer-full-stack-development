...
- [Modules](#modules)  
  ...
  2. [HTML and CSS refresher](modules/02-html-and-css-refresher)  
  3. [Introduction to JavaScript](modules/03-introduction-to-javascript)  
  4. [Advanced JavaScript](modules/04-advanced-javascript)  
  5. [jQuery](modules/05-jquery)  
  6. [Working with RESTful APIs](modules/06-working-with-restful-apis)  
  7. [Fundamentals of NodeJS](modules/07-fundamentals-of-nodejs)  
  8. [Routing with Express](modules/08-routing-with-express)  
  9. [MongoDB](#mongodb)  
